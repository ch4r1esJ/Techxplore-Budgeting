...
extension Color {
    static let customContainer = Color(red: 0.122, green: 0.212, blue: 0.243)
    static let activePill = Color(red: 0.008, green: 0.686, blue: 0.965)
    static let purposeActivePill = Color(red: 0.25, green: 0.28, blue: 0.35)
